      ...
      <div className="max-w-2xl">
        <div className="border border-brand-gray-200 rounded-lg bg-white overflow-hidden">
          <div className="p-6 sm:p-8">
            <h2 className="font-serif text-xl mb-2">Need help with your order?</h2>
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-center gap-4 border border-brand-gray-200 rounded-lg px-5 py-4 hover:border-brand-gray-400 transition-colors group"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium group-hover:text-black transition-colors">Chat on WhatsApp</p>
                  <p className="text-xs text-brand-gray-500">Get instant support</p>
                </div>
                <svg
                  className="shrink-0 text-brand-gray-400 group-hover:translate-x-1 transition-transform"
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium group-hover:text-black transition-colors">Email Us</p>
            ...
            <div className="mt-8 pt-6 border-t border-brand-gray-100">
              <h3 className="font-mono text-xs uppercase tracking-widest text-brand-gray-400 mb-4">
  ...
  return (
    <details className="group border-b border-brand-gray-100 last:border-b-0">
      <summary className="flex items-center justify-between py-4 text-sm font-medium cursor-pointer list-none">
        {question}
        <svg
          className="w-4 h-4 text-brand-gray-400 group-open:rotate-45 transition-transform"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
