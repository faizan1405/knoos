 ...
 *
 * This file has ZERO external imports. It is self-contained.
 */

// ═══════════════════════════════════════════════════════════════════════════════
// CONSTANTS (inlined to avoid cross-file dependencies)
// ═══════════════════════════════════════════════════════════════════════════════
...
// Slugs use the project's slugify() convention: spaces become hyphens.

const SOURCE_CATEGORY_NORMALIZE: Record<string, string> = { casual: "casuals" };
...
export const ROADSTER_DESCRIPTION_SKUS = new Set([
  "WAV-324-BL", "WAV-324-BLU", "WAV-324-PINK",
  "UD-6000-BL", "UD-6000-BR", "UD-6004-BL", "UD-6004-BR",
]);

export const COLOR_DESCRIPTION_MISMATCHES = [
...
export const BLANK_DESCRIPTION_SKUS = new Set([
  "UD-5101-BR", "UD-5101-TAN", "UD-5200-BL", "UD-5200-BLU", "UD-5200-GREY",
]);

export const BLANK_SALEPRICE_SKUS = new Set([
...
export const IMPORT_REQUIRED_CATEGORIES = [
